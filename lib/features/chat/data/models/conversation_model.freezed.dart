...
@HiveField(0) String get id;@HiveField(1) List<String> get participantIds;@HiveField(2) List<UserModel> get participants;@HiveField(3) MessageModel? get lastMessage;@HiveField(4) int get unreadCount;@HiveField(5) DateTime get updatedAt;
...
@useResult
$Res call({
@HiveField(0) String id,@HiveField(1) List<String> participantIds,@HiveField(2) List<UserModel> participants,@HiveField(3) MessageModel? lastMessage,@HiveField(4) int unreadCount,@HiveField(5) DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  List<String> participantIds, @HiveField(2)  List<UserModel> participants, @HiveField(3)  MessageModel? lastMessage, @HiveField(4)  int unreadCount, @HiveField(5)  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConversationModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  List<String> participantIds, @HiveField(2)  List<UserModel> participants, @HiveField(3)  MessageModel? lastMessage, @HiveField(4)  int unreadCount, @HiveField(5)  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ConversationModel():
return $default(_that.id,_that.participantIds,_that.participants,_that.lastMessage,_that.unreadCount,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)  String id, @HiveField(1)  List<String> participantIds, @HiveField(2)  List<UserModel> participants, @HiveField(3)  MessageModel? lastMessage, @HiveField(4)  int unreadCount, @HiveField(5)  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ConversationModel() when $default != null:
return $default(_that.id,_that.participantIds,_that.participants,_that.lastMessage,_that.unreadCount,_that.updatedAt);case _:
  return null;
...
class _ConversationModel extends ConversationModel {
  const _ConversationModel({@HiveField(0) required this.id, @HiveField(1) required final  List<String> participantIds, @HiveField(2) required final  List<UserModel> participants, @HiveField(3) this.lastMessage, @HiveField(4) this.unreadCount = 0, @HiveField(5) required this.updatedAt}): _participantIds = participantIds,_participants = participants,super._();
  factory _ConversationModel.fromJson(Map<String, dynamic> json) => _$ConversationModelFromJson(json);

@override@HiveField(0) final  String id;
 final  List<String> _participantIds;
@override@HiveField(1) List<String> get participantIds {
...
@override@HiveField(2) List<UserModel> get participants {
  if (_participants is EqualUnmodifiableListView) return _participants;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_participants);
}

@override@HiveField(3) final  MessageModel? lastMessage;
@override@JsonKey()@HiveField(4) final  int unreadCount;
