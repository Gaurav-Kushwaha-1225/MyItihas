...
mixin _$Message {
 ...
 String get id; String get conversationId; String get senderId; String get senderName; String get senderAvatar; String get text; DateTime get timestamp; MessageDeliveryStatus get deliveryStatus; List<String> get readBy; String? get sharedStoryId;
...
@override
String toString() {
  return 'Message(id: $id, conversationId: $conversationId, senderId: $senderId, senderName: $senderName, senderAvatar: $senderAvatar, text: $text, timestamp: $timestamp, deliveryStatus: $deliveryStatus, readBy: $readBy, sharedStoryId: $sharedStoryId)';
}
...
@useResult
$Res call({
 String id, String conversationId, String senderId, String senderName, String senderAvatar, String text, DateTime timestamp, MessageDeliveryStatus deliveryStatus, List<String> readBy, String? sharedStoryId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String conversationId,  String senderId,  String senderName,  String senderAvatar,  String text,  DateTime timestamp,  MessageDeliveryStatus deliveryStatus,  List<String> readBy,  String? sharedStoryId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Message() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String conversationId,  String senderId,  String senderName,  String senderAvatar,  String text,  DateTime timestamp,  MessageDeliveryStatus deliveryStatus,  List<String> readBy,  String? sharedStoryId)  $default,) {final _that = this;
switch (_that) {
case _Message():
return $default(_that.id,_that.conversationId,_that.senderId,_that.senderName,_that.senderAvatar,_that.text,_that.timestamp,_that.deliveryStatus,_that.readBy,_that.sharedStoryId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String conversationId,  String senderId,  String senderName,  String senderAvatar,  String text,  DateTime timestamp,  MessageDeliveryStatus deliveryStatus,  List<String> readBy,  String? sharedStoryId)?  $default,) {final _that = this;
switch (_that) {
case _Message() when $default != null:
return $default(_that.id,_that.conversationId,_that.senderId,_that.senderName,_that.senderAvatar,_that.text,_that.timestamp,_that.deliveryStatus,_that.readBy,_that.sharedStoryId);case _:
  return null;
...
@override final  String? sharedStoryId;
