...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String conversationId,  List<Message> messages,  bool isTyping,  bool isSending)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ChatDetailInitial() when initial != null:
return initial();case ChatDetailLoading() when loading != null:
return loading();case ChatDetailLoaded() when loaded != null:
return loaded(_that.conversationId,_that.messages,_that.isTyping,_that.isSending);case ChatDetailError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String conversationId,  List<Message> messages,  bool isTyping,  bool isSending)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case ChatDetailInitial():
return initial();case ChatDetailLoading():
return loading();case ChatDetailLoaded():
return loaded(_that.conversationId,_that.messages,_that.isTyping,_that.isSending);case ChatDetailError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String conversationId,  List<Message> messages,  bool isTyping,  bool isSending)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case ChatDetailInitial() when initial != null:
return initial();case ChatDetailLoading() when loading != null:
return loading();case ChatDetailLoaded() when loaded != null:
...
class ChatDetailLoaded extends ChatDetailState {
  const ChatDetailLoaded({required this.conversationId, required final  List<Message> messages, this.isTyping = false, this.isSending = false}): _messages = messages,super._();
...
@override
int get hashCode => Object.hash(runtimeType,conversationId,const DeepCollectionEquality().hash(_messages),isTyping,isSending);

@override
String toString() {
  return 'ChatDetailState.loaded(conversationId: $conversationId, messages: $messages, isTyping: $isTyping, isSending: $isSending)';
}
...
@useResult
$Res call({
 String conversationId, List<Message> messages, bool isTyping, bool isSending
});
...
/// Create a copy of ChatDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? conversationId = null,Object? messages = null,Object? isTyping = null,Object? isSending = null,}) {
