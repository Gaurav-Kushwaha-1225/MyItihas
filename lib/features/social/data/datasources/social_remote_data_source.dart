    ...
    try {
      ...
      return (response as List).map((json) {
        return LikeModel(
          ...
          storyId: json['likeable_id'] as String,
    ...
    try {
      ...
      for (final commentJson in response) {
        ...
        final comment = CommentModel(
          ...
          timestamp: DateTime.parse(commentJson['created_at'] as String),
    ...
    try {
      ...
      for (final replyJson in response) {
        ...
        replies.add(CommentModel(
          ...
          timestamp: DateTime.parse(replyJson['created_at'] as String),
  ...
  Future<void> shareStory({
    ...
    try {
      ...
      switch (shareType) {
        ...
        // Note: repost is stored in DB but maps to external in app
        // as ShareType.repost doesn't exist in the domain enum
      }
    ...
    try {
      ...
      return (response as List).map((json) {
        ...
        switch (json['share_type'] as String) {
          ...
          case 'repost':
            shareType = ShareType.external; // Map repost to external
          default:
        ...
        return ShareModel(
          userId: json['user_id'] as String,
          storyId: json['shareable_id'] as String,
          shareType: shareType,
