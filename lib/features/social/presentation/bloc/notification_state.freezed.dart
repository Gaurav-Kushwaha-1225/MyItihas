...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<notif.Notification> notifications,  int unreadCount,  bool hasMore,  bool isLoadingMore)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NotificationInitial() when initial != null:
return initial();case NotificationLoading() when loading != null:
return loading();case NotificationLoaded() when loaded != null:
return loaded(_that.notifications,_that.unreadCount,_that.hasMore,_that.isLoadingMore);case NotificationError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<notif.Notification> notifications,  int unreadCount,  bool hasMore,  bool isLoadingMore)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case NotificationInitial():
return initial();case NotificationLoading():
return loading();case NotificationLoaded():
return loaded(_that.notifications,_that.unreadCount,_that.hasMore,_that.isLoadingMore);case NotificationError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<notif.Notification> notifications,  int unreadCount,  bool hasMore,  bool isLoadingMore)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case NotificationInitial() when initial != null:
return initial();case NotificationLoading() when loading != null:
return loading();case NotificationLoaded() when loaded != null:
...
class NotificationInitial extends NotificationState {
  const NotificationInitial(): super._();
...
class NotificationLoaded extends NotificationState {
  const NotificationLoaded({required final  List<notif.Notification> notifications, required this.unreadCount, required this.hasMore, this.isLoadingMore = false}): _notifications = notifications,super._();
  

 final  List<notif.Notification> _notifications;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationLoaded&&const DeepCollectionEquality().equals(other._notifications, _notifications)&&(identical(other.unreadCount, unreadCount) || other.unreadCount == unreadCount)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_notifications),unreadCount,hasMore,isLoadingMore);

@override
String toString() {
  return 'NotificationState.loaded(notifications: $notifications, unreadCount: $unreadCount, hasMore: $hasMore, isLoadingMore: $isLoadingMore)';
}
...
@useResult
$Res call({
 List<notif.Notification> notifications, int unreadCount, bool hasMore, bool isLoadingMore
});
...
/// Create a copy of NotificationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? notifications = null,Object? unreadCount = null,Object? hasMore = null,Object? isLoadingMore = null,}) {
...
as List<notif.Notification>,unreadCount: null == unreadCount ? _self.unreadCount : unreadCount // ignore: cast_nullable_to_non_nullable
...
class NotificationError extends NotificationState {
  const NotificationError(this.message): super._();
