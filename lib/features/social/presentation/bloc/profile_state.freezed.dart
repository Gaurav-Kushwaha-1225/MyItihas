...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( User user,  List<User> followers,  List<User> following,  bool isLoadingFollowers,  bool isLoadingFollowing)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ProfileInitial() when initial != null:
return initial();case ProfileLoading() when loading != null:
return loading();case ProfileLoaded() when loaded != null:
return loaded(_that.user,_that.followers,_that.following,_that.isLoadingFollowers,_that.isLoadingFollowing);case ProfileError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( User user,  List<User> followers,  List<User> following,  bool isLoadingFollowers,  bool isLoadingFollowing)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case ProfileInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( User user,  List<User> followers,  List<User> following,  bool isLoadingFollowers,  bool isLoadingFollowing)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case ProfileInitial() when initial != null:
return initial();case ProfileLoading() when loading != null:
return loading();case ProfileLoaded() when loaded != null:
...
class ProfileLoaded extends ProfileState {
  const ProfileLoaded({required this.user, final  List<User> followers = const [], final  List<User> following = const [], this.isLoadingFollowers = false, this.isLoadingFollowing = false}): _followers = followers,_following = following,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileLoaded&&(identical(other.user, user) || other.user == user)&&const DeepCollectionEquality().equals(other._followers, _followers)&&const DeepCollectionEquality().equals(other._following, _following)&&(identical(other.isLoadingFollowers, isLoadingFollowers) || other.isLoadingFollowers == isLoadingFollowers)&&(identical(other.isLoadingFollowing, isLoadingFollowing) || other.isLoadingFollowing == isLoadingFollowing));
}


@override
int get hashCode => Object.hash(runtimeType,user,const DeepCollectionEquality().hash(_followers),const DeepCollectionEquality().hash(_following),isLoadingFollowers,isLoadingFollowing);

@override
String toString() {
  return 'ProfileState.loaded(user: $user, followers: $followers, following: $following, isLoadingFollowers: $isLoadingFollowers, isLoadingFollowing: $isLoadingFollowing)';
}
...
@useResult
$Res call({
 User user, List<User> followers, List<User> following, bool isLoadingFollowers, bool isLoadingFollowing
});
...
/// Create a copy of ProfileState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? user = null,Object? followers = null,Object? following = null,Object? isLoadingFollowers = null,Object? isLoadingFollowing = null,}) {
