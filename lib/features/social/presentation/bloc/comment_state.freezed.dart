...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String storyId,  List<Comment> comments,  Map<String, bool> collapsedStates,  bool isAddingComment)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CommentInitial() when initial != null:
return initial();case CommentLoading() when loading != null:
return loading();case CommentLoaded() when loaded != null:
return loaded(_that.storyId,_that.comments,_that.collapsedStates,_that.isAddingComment);case CommentError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String storyId,  List<Comment> comments,  Map<String, bool> collapsedStates,  bool isAddingComment)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case CommentInitial():
return initial();case CommentLoading():
return loading();case CommentLoaded():
return loaded(_that.storyId,_that.comments,_that.collapsedStates,_that.isAddingComment);case CommentError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String storyId,  List<Comment> comments,  Map<String, bool> collapsedStates,  bool isAddingComment)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case CommentInitial() when initial != null:
return initial();case CommentLoading() when loading != null:
return loading();case CommentLoaded() when loaded != null:
...
class CommentLoaded extends CommentState {
  const CommentLoaded({required this.storyId, required final  List<Comment> comments, final  Map<String, bool> collapsedStates = const {}, this.isAddingComment = false}): _comments = comments,_collapsedStates = collapsedStates,super._();
...
@override
int get hashCode => Object.hash(runtimeType,storyId,const DeepCollectionEquality().hash(_comments),const DeepCollectionEquality().hash(_collapsedStates),isAddingComment);

@override
String toString() {
  return 'CommentState.loaded(storyId: $storyId, comments: $comments, collapsedStates: $collapsedStates, isAddingComment: $isAddingComment)';
}
...
@useResult
$Res call({
 String storyId, List<Comment> comments, Map<String, bool> collapsedStates, bool isAddingComment
});
...
/// Create a copy of CommentState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? storyId = null,Object? comments = null,Object? collapsedStates = null,Object? isAddingComment = null,}) {
