...
class NotificationService {
  ...
  Future<void> markAsRead(String notificationId) async {
    ...
    try {
      ...
      }).eq('id', notificationId).eq('recipient_id', currentUserId);
  ...
  Stream<Map<String, dynamic>> subscribeToNotifications() {
    ...
    controller = StreamController<Map<String, dynamic>>(
      onListen: () {
        ...
        logger.info('[NotificationService] Subscribing to real-time notifications');
        isSubscribed = true;
  ...
  Future<List<Map<String, dynamic>>> getGroupedNotifications({
    ...
    try {
      ...
      final notifications = await getNotifications(limit: limit * 2, offset: offset);
        ...
        if (entityId != null && type != null) {
          ...
          if (grouped.containsKey(key)) {
            ...
            grouped[key] = {
              ...
              'actors': [if (notification['actor'] != null) notification['actor']],
              'count': 1,
