...
class StoryDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String text =
        storyData['text'] ?? "The requested story content goes here...";
    final String reference =
        storyData['reference'] ?? "The requested story content goes here...";
  ...
  Widget _buildInteractionCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? DarkColors.glassBg.withAlpha(50) : LightColors.glassBg.withAlpha(50),
        borderRadius: BorderRadius.circular(15),
        border: Border.all(color: LightColors.accentPrimary.withAlpha(50), width: 1.5),
      ),
      child: Column(
        children: [
